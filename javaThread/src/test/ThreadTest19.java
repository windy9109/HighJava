...
public class ThreadTest19 {
	...
	public static void main(String[] args) {
		...
		ProducerThread1 th1 = new ProducerThread1(box);
...
class DataBox{
	...
	String temp = data;
	data = null;
	System.out.println("스레드가 보내주는 데이터: "+temp);
	notify();
	...
	//데이터를 저장하는 메서드
	//data변수에 값이 있으면 data변수에 값이 null이 될때까지 기다린다.
	//data변수 값이 null이 되면 새로운 data(매개변수값)을 저장한다.
	public synchronized void setData(String data) {
		...
		this.data = data;
		System.out.println("Thread메서 새로 저장한 데이터: "+data);
		notify();
	}
...
class ProducerThread1 extends Thread{
	...
	public ProducerThread1(DataBox databox) {
