...
<html>
 <head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
   ...
   $(function(){
	   $.ajax({
		   url: '/cumtrip/selectallrestaurant.do', 
		   type : 'get',
		   async:false,
	...
	$(document).on('click','#detailspace', function(){
		...
		$.ajax({
			...
			success : function(res){
		     ...
		     str+=     '<h4 class="modal-title">음식점 수정</h4>'                                              ;
		     str+=     '<button type="button" class="close" data-dismiss="modal">&times;</button>'               ;
		     str+=   '</div>'                                                                                    ;
		     str+=   '<div class="modal-body">'                                                                  ;
		  	 str+=  '<form id="modify" action="/cumtrip/updaterestaurant.do?midno='+res.mid_no +'" method="post" >';
		     str+= '<table>'                                                                                     ;
		     str+= 	'<tr>'                                                                                       ;
		     str+= 		'<td>음식점 번호</td>'                                                                        ;
