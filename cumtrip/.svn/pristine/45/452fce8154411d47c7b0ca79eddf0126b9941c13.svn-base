...
public class MemberDaolmpl implements IMemberDao {
	...
	public Object mypage_payUdate01(String cart) throws SQLException {
		return (Object)client.insert("member.mypage_payUdate01", cart);
	}

	@Override
	public int mypage_payUdate02(String cart) throws SQLException {
		return (int)client.update("member.mypage_payUdate02", cart);
	}

	@Override
	public List<MemberVO> taste_select(String id) throws SQLException {
		return client.queryForList("member.taste_select", id);
	}

	@Override
	public int taste_update(MemberVO vo) throws SQLException {
		return (int)client.update("member.taste_update", vo);
	}

	@Override
	public Object taste_insert(MemberVO vo) throws SQLException {
		return (Object)client.insert("member.taste_insert", vo);
	}

	@Override
	public int taste_delect(String id) throws SQLException {
		return (int)client.delete("member.taste_delete", id);
	}
