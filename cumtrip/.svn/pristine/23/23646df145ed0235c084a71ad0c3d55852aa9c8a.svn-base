...
public class SubmainDaoImpl implements ISubmainDao{
	...
	public List<SubPrintVO> tourList1(String addr) throws SQLException {
		return client.queryForList("sub.tourlist1", addr); // namespace.id
	}
	

	@Override
	public List<SubPrintVO> tourList2(String addr) throws SQLException {
		return client.queryForList("sub.tourlist2", addr); // namespace.id
	}

	@Override
	public List<SubPrintVO> tourList3(String addr) throws SQLException {
		return client.queryForList("sub.tourlist3", addr); // namespace.id
	}
