							...
							<div class="plz">
								<div id="l1">
									<span class="att">
										...
										<h4 class="f1 hgr1">즐길거리</h4>
										<p class="f4 rfg1">볼 것, 돌아다닐 곳, 체험할 수 있는 명소가 넘쳐납니다.</p>
										<a href="sub_tour.jsp?addr=<%=addr %>" style="text-decoration: underline;" class="f4 mghg1">모두 보기</a>
									</span>
								</div>
...
<!-- 
						...
						<div id="myCarousel2" class="carousel slide">
							...
							<div class="plz">
								<div id="l2">
									<span class="att">																		<!-- Indicators 몇 개의 슬라이드가 있고 현재 어느 슬라이드인지 알려주는 부분 -->
										<div class="in">
											<ul class="carousel-indicators">
										...
										<h4 class="f1 hgr1">숙소</h4>
										<p class="f4 rfg1">매력적이고 현대적인 믿을 수 있는 호텔</p> 
										<a href="/cumtrip/view/jsp/submain.jsp?addr=대전" style="text-decoration: underline;" class="f4 mghg1">모두 보기</a>
									</span>
								</div>
							...
							<div class="plz">
								<div id="l3">
									<span class="att">
										...
										<h4 class="f1 hgr1">음식점</h4>
										<p class="f4 rfg1">먹지 마시고 연회하기 좋은 장소를 놓치지 마세요.</p> 
										<a href="/cumtrip/view/jsp/submain.jsp?addr=대전" style="text-decoration: underline;" class="f4 mghg1">모두 보기</a>
									</span>
								</div>
