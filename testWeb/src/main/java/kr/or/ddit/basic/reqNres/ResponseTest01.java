...
public class ResponseTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 * - forward방식 ==> 특정 서블릿에 대한 요청을 다른 서블릿이나 JSP로 제어를 넘긴다.(파라미터도 넘길수 있다.)
		 ...
		 *  ==> "이동할 서블릿이나 JSP주소는 '컨텍스트 패스'이후의 주소를 기술하면된다."
		 *  예) 이동할 주소가 "http://localhost/testWeb/test.do"라고하면 "/test.do"만 기술하면 된다.
		 *  
		*/
